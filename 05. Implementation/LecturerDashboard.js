...
import { View, Text, StyleSheet, TouchableOpacity, ScrollView, RefreshControl, Alert, Platform, Modal, TextInput, Button } from 'react-native';
...
const LecturerDashboard = () => {
      ...
      >
        ...
        <View style={styles.statsContainer}>
          <View style={styles.statCard}>
            <Ionicons name="calendar" size={24} color="#8D6748" />
          ...
          <View style={styles.statCard}>
            <Ionicons name="time" size={24} color="#A9A9A9" />
        ...
        <View style={styles.actionsSection}>
          ...
          <View style={styles.actionsRow}>
            ...
            >
              <View style={[styles.actionIcon, { backgroundColor: "#8D6748" }]}>
            ...
            <TouchableOpacity 
              ...
              onPress={handleManageClasses}
            >
              <View style={[styles.actionIcon, { backgroundColor: "#222222" }]}>
  ...
  const getClassColor = (courseCode) => {
    // Use brown, black, and gray for class color indicators
    const colors = ['#8D6748', '#222222', '#A9A9A9'];
    let hash = 0;
      ...
      <Modal visible={editModalVisible} transparent animationType="slide">
        <View style={{flex:1,justifyContent:'center',alignItems:'center',backgroundColor:'rgba(0,0,0,0.3)'}}>
          <View style={{backgroundColor:'#fff',padding:20,borderRadius:10,width:300}}>
            ...
            <TextInput style={styles.input} value={editData.department} onChangeText={t=>setEditData({...editData,department:t})} placeholder="Department" />
